...
match_score: 84
score_breakdown: '[{"category": "Role Match", "matched": 2, "total": 11, "weight": 3, "pct": 67, "keywords_hit": ["product manager", "product owner"]}, {"category": "Domain Match", "matched": 3, "total": 17, "weight": 2, "pct": 75, "keywords_hit": ["saas", "ai", "platform"]}, {"category": "Hard Skills", "matched": 9, "total": 24, "weight": 2, "pct": 100, "keywords_hit": ["agile", "scrum", "roadmap", "go-to-market", "sprint"]}, {"category": "Tools", "matched": 2, "total": 14, "weight": 1.5, "pct": 67, "keywords_hit": ["jira", "confluence"]}, {"category": "AI & Tech Skills", "matched": 1, "total": 19, "weight": 2.5, "pct": 25, "keywords_hit": ["ai"]}, {"category": "Soft Skills", "matched": 4, "total": 12, "weight": 1, "pct": 100, "keywords_hit": ["remote", "collaboration", "communication", "strategic"]}, {"category": "Location Preference", "matched": 3, "total": 12, "weight": 1.5, "pct": 100, "keywords_hit": ["remote", "indonesia", "apac"]}, {"category": "Business Impact", "matched": 2, "total": 16, "weight": 1.5, "pct": 50, "keywords_hit": ["arr", "go-to-market"]}]'
description_quality: "full"
status: "Ready to Apply"
url: "https://sg.linkedin.com/jobs/view/product-manager-at-activate-interactive-4437765003"
...
Product Manager
What will you do?
We are a team that aims to design and develop software applications that help government agencies better serve the needs the community. We adopt an Agile development approach and work towards adopting tech best practices and cutting edge tools.
...
Responsible for tracking the application bugs, assessing impact and severity of bugs
Follow up and support assistance where required for the team to resolve any impediments or issues they faced from their daily standup
...
Solid understanding of end-to-end agile software development process (Scrum and Kanban)
...
Experience with using, maintaining and customizing software development tools such as Confluence, SharePoint, Jira
